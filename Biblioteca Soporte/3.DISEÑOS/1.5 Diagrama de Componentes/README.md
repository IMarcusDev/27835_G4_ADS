...
|--------------------|-----------------------------|-----------------------------|--------------------------------|-----------------------------------|-----------------|----------------------|----------------------------------|
| DCO | Diagrama de Componentes | Mateo Sosa | 27835_G4_ADS/Biblioteca Soporte/3.DISEÑOS/1.5 Diagrama de Componentes/ | LBD | Documentación | 15/01/2026 | 15/01/2026 |
...
- Relaciones y comunicación entre componentes
...
| -------------------------- | ----------- | ------------------------------------------- |
| DCO_MinGO_v1.0.pdf         | V1.0        | **VERSIÓN FINAL APROBADA** - Diagrama de componentes |
