# Matriz de Trazabilidad IREB - VERSIÓN FINAL DE SOPORTE
...
| ------------------ | ----------------------------- | ---------------------------------------- | ------------------------------------------------------------------ | --------------------------------- | --------------- | --------------------- | -------------------------------- |
| MTZ                | Matriz de Trazabilidad IREB   | Marcos Escobar, Mateo Sosa, Fernando Tipán | 27835_G4_ADS/Biblioteca Soporte/1. ELICITACION/1.3 Matriz IREB/ | LBR                               | Documentación   | 25/11/2025            | 25/11/2025                       |

## Descripción del Artefacto

La matriz IREB permite la trazabilidad bidireccional entre:
- Requisitos de usuario y requisitos del sistema
- Requisitos funcionales y casos de uso
- Requisitos y componentes de diseño
- Requisitos y casos de prueba

## Trazabilidad y Versionamiento

Durante el desarrollo se generaron 3 versiones (V1.0 - V3.0). Esta biblioteca contiene la **versión final V3.0** de soporte aprobada por el comité de configuración el 29/01/2026. El historial completo de versiones se encuentra en la Biblioteca de Trabajo.

## Archivo Final de Soporte

| **Archivo**                        | **Versión** | **Estado**                              |
| ---------------------------------- | ----------- | -------------------------------------------- |
| G4_27835_Matriz_IREBv3.0.xlsx      | V3.0        | **VERSIÓN FINAL APROBADA** - Trazabilidad completa  |
