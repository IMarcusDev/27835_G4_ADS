...
|--------------------|-----------------------------|-----------------------------|--------------------------------|-----------------------------------|-----------------|----------------------|----------------------------------|
| DCU | Diagrama de Casos de Uso Extendido | Marcos Escobar | 27835_G4_ADS/Biblioteca de Trabajo/3.DISEÑOS/1.3 Casos de Uso Extendido/ | LBD | Documentación | 15/01/2026 | 15/01/2026 |

## Control de Configuración
- **Verificado por:** Mateo Sosa (Gestor de Configuración)
- **Fecha de verificación:** 27/01/2026
- **Estado:** Casos de uso verificados